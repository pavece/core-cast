...
export const Navbar = ({ userProfile }: Props) => {
	...
	return (
		<nav className='sticky top-0 z-50 bg-background/70 backdrop-blur-lg flex items-center justify-center'>
			<div className='flex items-center justify-between p-3 2xl:px-0 gap-2 w-full max-w-[1700px]'>
				{!mobileSearchEnabled && (
					<Link href='/'>
